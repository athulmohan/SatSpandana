...
if(isset($_POST['submit']))
{
	...
	if($query)
	{
		...
		$message = 'Registeration Failed. Please try later.';
		$type = 'warning';
	}
}
?>
    ...
    <div class="row">
        <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
            <div class="logo margin-top-30">
                <a href="../index.php">
                    <h2>SAT SPANDANA | Patient Registration</h2>
                </a>
            </div>
            <!-- start: REGISTER BOX -->
            <div class="box-register">
                ...
                <div class="copyright">
                    &copy; <span class="current-year"></span><span class="text-bold text-uppercase"> SAT SPANDANA</span>.
