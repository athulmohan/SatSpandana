	...
	if(isset($_POST['submit'])){
		...
		if(isset($name) && $name !== '' && isset($email) && $email !== '') {
			...
			if($row>0){
				...
				$message = 'Invalid details. Please try with valid details';
				$type = 'warning';
	...
	<?php include_once('include/notification.php'); ?>
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> SAT SPANDANA | Patient Password Recovery</h2></a>
				</div>
				...
				<div class="box-login">
					...
					<div class="copyright">
						&copy; <span class="text-bold text-uppercase">  SAT Spandana</span>
					</div>
