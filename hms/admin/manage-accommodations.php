...
{
	$id=$_GET['id'];
	mysqli_query($con,"delete from accommodations where id ='$id'");
...
<head>
    <title>Admin | Manage Accommodations</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Manage Accommodations</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Admin</span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15">Manage <span
                                        class="text-bold">Accommodations</span>
                                </h5>
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                        <?php
$sql=mysqli_query($con,"select * from accommodations");
$cnt=1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                    <a href="edit-accommodations.php?id=<?php echo $row['id'];?>"
                                                        class="btn btn-transparent btn-xs" tooltip-placement="top"
                                                        tooltip="Edit"><i class="fa fa-pencil"></i></a>

                                                    <a href="manage-accommodations.php?id=<?php echo $row['id']?>&del=delete"
