...
<header class="navbar navbar-default navbar-static-top">
    ...
    <div class="navbar-header">
        ...
        <div class=""> <!-- col-lg-2 col-md-3 col-sm-3 -->
            ...
            <!-- <h2 style="padding-top:20%; color:#000 ">SAT SPANDANA</h2> -->
                <img src="../../assets/images/satspandana-logo-png.png" alt="SAT SPANDANA" style="width: 135px;">
            </a>
        </div>
    ...
    <div class="navbar-collapse collapse">
        <ul class="nav navbar-right">
            ...
            <li>
                <h3 style="margin: 0; margin-top: 20px;">SAT SPANDANA</h3>
            </li>
