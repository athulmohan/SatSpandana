                ...
                <li>
                    <a href="javascript:void(0)">
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                <span class="title"> Packages </span><i class="icon-arrow"></i>
                            </div>
                        </div>
                    </a>
                    <ul class="sub-menu">
                ...
                <li>
                    <a href="javascript:void(0)">
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                <span class="title"> Accommodations </span><i class="icon-arrow"></i>
                            </div>
                        </div>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a href="add-accommodation.php">
                                <span class="title"> Add Accommodation</span>
                            </a>
                        </li>
                        <li>
                            <a href="manage-accommodations.php">
                                <span class="title"> Manage Accommodations </span>
                            </a>
                        </li>
                ...
                <li>
                    <a href="manage-slots.php">
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                <span class="title"> Manage Booking Slot </span>
                            </div>
                        </div>
                    </a>
                </li>
