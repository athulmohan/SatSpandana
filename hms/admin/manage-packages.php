...
if(strlen($_SESSION['id']==0)) {
    ...
    {
        $packageid=$_GET['id'];
        mysqli_query($con,"delete from packages where id ='$packageid'");
                ...
                <div class="main-content">
                    <div class="wrap-content container" id="container">
                        ...
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">Admin | Manage Packages</h1>
                                </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <span>Admin</span>
                        ...
                        <div class="container-fluid container-fullw bg-white">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Packages</span>
                                    </h5>
                                    ...
                                    <table class="table table-hover" id="sample-table-1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hidden-xs">Treatment Name</th>
                                                <th>Creation Date </th>
                                                <th>Action</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="visible-md visible-lg visible-sm visible-xs">
                                                        <a href="edit-packages.php?id=<?php echo $row['id'];?>"
                                                            class="btn btn-transparent btn-xs" tooltip-placement="top"
                                                            tooltip="Edit"><i class="fa fa-pencil"></i></a>

                                                        <a href="manage-packages.php?id=<?php echo $row['id']?>&del=delete"
